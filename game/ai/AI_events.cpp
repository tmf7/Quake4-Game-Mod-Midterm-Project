...
CLASS_DECLARATION( idActor, idAI )
	...
	EVENT( AI_TakeDamage,						idAI::Event_TakeDamage )		//TMF7 1of2 in this file (and an extern in the .h)
	...
	// Misc
	EVENT( AI_Attack,							idAI::Event_Attack )		//TMF7 1of1 and extern
	...
	EVENT( AI_StopRagdoll,						idAI::Event_StopRagdoll ) //TMF7 only one, not in the .h as extern (yet)
	...
	EVENT( AI_TakeDamage,						idAI::Event_TakeDamage )		//TMF7 2of2 in this file (and an extern in the .h)
