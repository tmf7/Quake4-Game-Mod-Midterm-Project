...
2-place the Quake4Config.cfg from the attached .zip file in the q4base directory
...
4-Flash bang Bombs	( hyperblaster, any AI or player that can see the detonation loses target tracking
					 for a duration, player screen flashes white and fades over time)
5-
6-
7-
8-
...
hud mods/Magic System:
1-Third person hud and crossair visible (camera position and world clipping adjusted)
2-Mana bars integrated into ammo bar's background ammo percentage
3-Currently equipped spell name visible in Mana bar ( with lightning gun equipped )
4-Each spell has a maximum mana and casting cost, 
